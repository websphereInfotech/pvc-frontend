...
function createData(date, invoiceno, customer, texableamount, otherchargesplus, otherchargesminus, disc, status, totalamount) {
  return { date, invoiceno, customer, texableamount, otherchargesplus, otherchargesminus, disc, status, totalamount };
}
